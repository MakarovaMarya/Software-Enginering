...
# Результат
<img width="1920" height="1039" alt="тема 9_6" src="https://github.com/user-attachments/assets/8c960cd0-635d-484c-b01b-15367e7f8335" />
...
# Общий вывод
Выполняя данные лаборатоные и самостоятельные задания, мы глубже погрузились в изучении принципов и концепций объектно-ориентированного программирования, а также разобрали примеры их реализации на Python. Также, мы сами написали довольно большую программу по выращиванию помидор и таким образом закрепили полученные ранее знания, а также поопрактиковались в создании классов, их атрибутов и методов.  
