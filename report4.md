...
# Вывод
Созздали простую функцию, которая выводит результат сложения двух цифр, и использовали "точку входа" для запуска функции именно в этом файле, и не в каком другом её запустить мы не сможем. 
